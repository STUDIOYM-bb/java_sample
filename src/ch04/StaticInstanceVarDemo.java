...
public class StaticInstanceVarDemo {
	...
	public static void main(String[] args) {
		...
		Circle2 c4 = new Circle2(0);
		Circle2.printStaticInfo();

		Circle2 c5 = new Circle2(0);
		Circle2.printStaticInfo();
...
class Circle2 {
	...
	// 필드 = 변수
	// 클래스 변수
	static int numOfCircle; // Method 영역에 올라갈 때 생성되며, 0으로 초기화 됨
	// 인스턴스 변수
	double radius; // 객체가 생성될 때 생성되며, 0.0 으로 초기화 됨
