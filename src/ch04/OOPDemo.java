...
public class OOPDemo {
	...
	public static void main(String[] args) {
		// 상속 전 코드는 반복이 있음 (변수, 반복문, 메서드, 상속)
		// 상속을 통해 반복을 없애보자. 수정을 부모 쪽에만 하면 자식도 같이 수정된다. 즉 유지보수성 상승.
...
class Eagle extends Animal {
	...
	void move() {
//		System.out.println(super.name + "는 움직입니다.");
		System.out.println(this.name + "는 날아갑니다.");
	}
}
...
class Fish extends Animal {
	...
	void move() {
//		System.out.println(super.name + "는 움직입니다.");
		System.out.println(this.name + "는 헤엄칩니다.");
	}
}